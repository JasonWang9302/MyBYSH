           ...
           <!--  <ul class="layui-nav layui-layout-left kit-nav">
            ...
            <ul class="layui-nav layui-layout-right kit-nav">
                <li class="layui-nav-item">
                    <a href="javascript:;">
                        <!-- <img src="" class="layui-nav-img"> --> 当前用户：${session.currAdmin.adminName}
                    </a>
            ...
            <div class="layui-side-scroll">
                ...
                <ul class="layui-nav layui-nav-tree" lay-filter="kitNavbar" kit-navbar>
			       ...
			       <!-- 	我的任务 -->
					 ...
					 <li class="layui-nav-item">
                         <a href="javascript:;" kit-target data-options="{url:'admin/projectList.jsp',icon:'&#xe658;',title:'Ddd',id:'8'}"><i class="layui-icon">&#xe658;</i><span>审核</span></a>
				     </li>
