...
<body>
    ...
    <blockquote class="layui-elem-quote layui-text">
        鉴于小伙伴的普遍反馈，先温馨提醒两个常见“问题”：1. <a href="/doc/base/faq.jsp#form" target="_blank">为什么select/checkbox/radio没显示？</a> 2. <a href="/doc/modules/form.jsp#render" target="_blank">动态添加的表单元素如何更新？</a>
    </blockquote>
