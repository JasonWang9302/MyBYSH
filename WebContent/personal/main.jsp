				...
				<div class="info-box">
					...
					<div class="info-box-content">
						<span class="info-box-text">Likes</span> <span
							class="info-box-number">25,412</span>
					</div>
				</div>
			</div>
			<div class="layui-col-md3">
				...
				<ul class="layui-timeline">
							...
							<ul>
								<li>交流群: <a target="_blank"
									href="//shang.qq.com/wpa/qunwpa?idkey=7d46b4a74805131378febabe99963fdd3e767544a34f9b92a9db0737ebf130a1"><img
										...
										alt="BeginnerAdmin" title="BeginnerAdmin"></a>
								</li>
								<li>点击进入群哦，如果实在加不了还有群号啊[248049395]</li>
								<li>大家在用的过程中有什么问题的话可以在群里问啊，别的先不写了...</li>
								<li><a href="index.1.jsp" target="_blank">点击查看一级菜单的加载</a></li>
							</ul>
						</div></li>
					<li class="layui-timeline-item"><i
						class="layui-icon layui-timeline-axis">&#xe63f;</i>
						<div class="layui-timeline-content layui-text">
							...
							<ul>
								<li><a href="index.2.jsp" target="_blank">点击我(灰色)</a></li>
								<li><a href="index.3.jsp" target="_blank">点击我(蓝色)</a></li>
								<li><a href="page.jsp" target="_blank">模板的另一种加载方式(page)</a></li>
								<li>更新到 layui 2.1.1 <a
									href="http://www.layui.com/doc/base/changelog.jsp"
					...
					<li class="layui-timeline-item"><i
						...
						<div class="layui-timeline-content layui-text">
							...
							<ul>
								<li>详见<a href="onelevel.jsp">说明文档</a></li>
							</ul>
							<h3>#Tab组件</h3>
							<ul>
								<li>添加选项卡加载进度条</li>
					...
					<li class="layui-timeline-item"><i
						...
						<div class="layui-timeline-content layui-text">
							...
							<h3>#Navbar组件</h3>
							<ul>
								<li>添加远程加载和本地加载的方式（设置方式详见<a href="navbar.jsp">说明文档</a>）
								</li>
							</ul>
							<h3>#Tab组件</h3>
							<ul>
								<li>添加 mainUrl 属性 默认：main.jsp</li>
							</ul>
							</p>
						</div></li>
					<li class="layui-timeline-item"><i
						...
						<div class="layui-timeline-content layui-text">
							...
							<p>
							<ul>
								<li>更新<a href="navbar.jsp">navbar组件</a>和<a href="tab.jsp">tab组件</a>的说明文档
								</li>
								<li>新增左侧菜单可缩进.</li>
					...
					<li class="layui-timeline-item"><i
						...
						<div class="layui-timeline-content layui-text">
							...
							<ul>
								<li>
									<p>添加message组件</p>
									<p>Example:</p> <pre class="layui-code">
...
});</pre><input type="button" class="layui-btn" value="点击我测试message组件"
									id="test" />
								</li>
								<li>tab组件添加两个属性：<span class="major">closeBefore</span>[关闭选项卡之前发生]、<span
									class="major">onSwitch</span>[选项卡切换时发生](具体请查看文档[好像文档还没加进去~~~])
								</li>
							</ul>
							</p>
						</div></li>
					<li class="layui-timeline-item"><i
						...
						<div class="layui-timeline-content layui-text">
							...
							<ul>
								...
								<li>添加navbar模块 <a href="navbar.jsp">navbar文档</a>
								</li>
								<li>添加tab模块 <a href="tab.jsp">tab文档</a>
								</li>
								<li>还有不想写了....</li>
							</ul>
							</p>
