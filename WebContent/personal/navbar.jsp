...
<body>
    <div class="kit-doc">
        <blockquote class="layui-elem-quote">Navbar组件是基于<a href="http://www.layui.com/doc/element/nav.jsp" target="_blank">layui导航菜单</a> 封装的组件，配合
            <a href="tab.jsp">tab组件</a>能完成多开页面的操作</blockquote>
        <div class="kit-doc-title">
            <fieldset>
                <legend><a name="blockquote">设置绑定方式</a></legend>
            </fieldset>
        </div>
        <p>提供两种设置方式(设置data属性 和 kit-target 属性),以下两种方式都能正确解析[详细请参考index.jsp]</p>
...
Example:
<pre class="layui-code">
data-url="form.jsp" data-icon="fa-user" data-title="表单" kit-target data-id='2' kit-target</pre></pre>
                    </td>
                </tr>
                <tr>
                    <td>方式二</td>
                    <td>
                        <pre class="layui-code">
kit-target data-options="{url:'test.jsp',icon:'fa-user',title:'表格',id:'1'}"</pre>
                    </td>
                </tr>
            </tbody>
        </table>
...
navbar.set{
    remote:{
        ...
        <blockquote class="layui-elem-quote">
            <pre class="layui-code">
//图标支持<a href="http://www.layui.com/doc/element/icon.jsp" target="_blank">layui图标</a>和<a href="http://www.fontawesome.com.cn/faicons/" target="_blank">fontawesome字体图标</a>
[{
    "id": "1",
    "title": "基本元素",
    "icon": "fa-cubes",
