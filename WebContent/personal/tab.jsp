...
<body>
	<div class="kit-doc">
		<blockquote class="layui-elem-quote">
			Tab组件是基于<a href="http://www.layui.com/doc/element/tab.jsp"
				target="_blank">layui选项卡</a> 封装的组件，配合 <a href="navbar.jsp">Navbar组件</a>能完成多开页面的操作
		</blockquote>
		<div class="kit-doc-title">
			<fieldset>
				<legend>
					<a name="blockquote">可用的方法</a>
				</legend>
			</fieldset>
		</div>
...
navbar.bind(function(data) {//bind方法为navbar组件提供的方法
    tab.tabAdd(data);
		...
		<div class="kit-doc-title">
			<fieldset>
				<legend>
					<a name="blockquote" id="options">options参数说明</a>
				</legend>
			</fieldset>
		</div>
		<table class="layui-table">
			...
			<tbody>
				...
				<tr>
					...
					<td>function</td>
					<td>undefined</td>
					<td>选择卡切换时将触发该事件<br /> 示例: <pre class="layui-code">
tab.set({
    onSwitch: function(data) { //选项卡切换时触发
        ...
        //console.log(data.elem); //得到当前的Tab大容器
				...
				<tr>
					...
					<td>function</td>
					<td>undefined</td>
					<td>关闭选项卡之前触发该事件<br /> 示例: <pre class="layui-code">
tab.set({
