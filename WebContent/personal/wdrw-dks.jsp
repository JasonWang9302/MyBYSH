...
<body>
	<div class="person">
		<div class="person-xdh">
			<a><font>我的任务</font></a> > <font>待开始</font>
		</div>
		<div class="content">
			<table class="layui-table"
				lay-data="{url:'wdrw-showDKS2', id:'idTest'}"
				lay-filter="demo">
				<thead>
					<tr>
														...
														if (obj.event === 'detail') {
															...
															/* window.location.href = "project-toEditProject?proId="
																	...
																	if(data.guaranteeStatus==0){
																		...
																		layer.confirm('无法启动：双方未完成担保<br/>去缴纳预付金？', {
																		  btn: ['是','否'] //按钮
																			...
																			layer.open({
																				...
																				area : [ '300px', '350px' ],
																				content : 'dealing-toPayMargin?proId='+data.proId
																			});  
																		...
																		layer.alert('发布者还未缴纳保证金，暂时无法开始');
																		//服务者未支付
																	}else if(data.guaranteeStatus==2){
																		//询问框
																		layer.confirm('您未完成保证金平台托管<br/>是否去缴纳保证金？', {
																		  btn: ['是','否'] //按钮
																		}, function(){
