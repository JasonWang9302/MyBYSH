					...
					$('#reg')
							.click(
									function() {
										...
										/*
										 * $.ajax({ type: reMethod, url:
										 * "/member/ajaxyz.php", data: "uid=" +
										 * $("#user").val() + '&temp=' + new
										 * Date(), dataType: 'html', success:
										 * function(result) {
										 * 
										 * if (result.length > 2) {
										 * $('#user').focus().css({ border: "1px
										 * solid red", boxShadow: "0 0 2px red"
										 * });$("#userCue").html(result); return
										 * false; } else { $('#user').css({
